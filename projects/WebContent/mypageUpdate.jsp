...
<body style="text-align: center;">
	...
	<form action="mypageUpdateOk.jsp" name= "mypageForm" method="post" id="mypageForm">
		...
		<tr>
		<td>비밀번호</td>
		<td><input class="logincss" type="password" name="new_pwd" id="pw" placeholder="비밀번호를 입력하세요." autofocus required></td>
		</tr>
		<tr>
		<th colspan = "2">
		...
		<tr>
		<td>비밀번호 확인</td>
		<td><input class="logincss" type="password" name="new_pwd2" id="pwCheck" placeholder="비밀번호를 입력하세요." required></td>
		</tr>
		<tr>
		<th colspan = "2">
		...
		<div style="margin-top: 5%">
			<!-- mypageUpdateOk로 이동 -->
			<form action = "mypageUpdateOK.jsp" method="post">
			<input class="loginbutton" type="submit" value="회원정보수정" onclick="return check()">
			</form>
			<!-- 회원탈퇴페이지로 이동 -->
